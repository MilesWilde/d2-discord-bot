...
export interface ThrownWeapon extends Weapon {
    oneHandMinimumDamage: number;
    oneHandMaximumDamage: number;
    thrownMinimumDamage: number;
    thrownMaximumDamage: number;
    speed: number;
    weaponSpeed: string;
}

export function CreateTwoHandedSwordImageDescription(weapon: ThrownWeapon) {
    ...
    const imageDescriptionList: ImageDescription[] = [
        ...
        {
            colour: HexItemColor.White,
            text: `Throw Damage: ${weapon.thrownMinimumDamage} To ${weapon.thrownMaximumDamage}`,
        },
        {
            colour: HexItemColor.White,
...
const setWeaponDamage = (weaponData: WeaponData) => {
    return (weapon: ThrownWeapon): ThrownWeapon => {
        return {
            ...weapon,
            thrownMinimumDamage: weaponData.minmisdam,
            thrownMaximumDamage: weaponData.maxmisdam,
