...
export interface TwoHandedSword extends Weapon {
...
export function CreateTwoHandedSwordImageDescription(weapon: TwoHandedSword) {
...
const setWeaponDamage = (weaponData: WeaponData) => {
    return (weapon: TwoHandedSword): TwoHandedSword => {
        return {
            ...weapon,
...
export const createTwoHandedSwordBase = (weaponData: WeaponData) => {
    return ramda.pipe(
