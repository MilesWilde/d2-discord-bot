...
export interface TwoHandedWeapon extends Weapon {
    twoHandMinimumDamage: number;
    twoHandMaximumDamage: number;
    speed: number;
    weaponSpeed: string;
}

export function CreateTwoHandedWeaponImageDescription(weapon: TwoHandedWeapon) {
    ...
    const imageDescriptionList: ImageDescription[] = [
        ...
        {
            colour: HexItemColor.White,
            text: `Two-Hand Damage: ${weapon.twoHandMinimumDamage} To ${weapon.twoHandMaximumDamage}`,
        },
        {
            colour: HexItemColor.White,
...
const setWeaponDamage = (weaponData: WeaponData) => {
    return (weapon: TwoHandedWeapon): TwoHandedWeapon => {
        return {
            ...weapon,
            twoHandMinimumDamage: weaponData["2handmindam"],
            twoHandMaximumDamage: weaponData["2handmaxdam"],
        };
    };
};

export const createTwoHandedWeaponBase = (weaponData: WeaponData) => {
    return ramda.pipe(
